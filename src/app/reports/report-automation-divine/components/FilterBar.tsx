...
const REPORT_TYPE_OPTIONS = [
  ...
  { label: "Vedic Life (#VLR)",           value: "#VLR-"  },
  { label: "Career (#CR1)",               value: "#CR1-"  },
  { label: "Vedic Health (#VHR)",               value: "#VHR-"  },
  { label: "Marriage / Love (#MLR)",      value: "#MLR-"  },
  { label: "Wealth & Finance (#WR)",      value: "#WR-"   },
  { label: "Education (#EAR)",            value: "#EAR-"  },
  { label: "Baby / Child (#BCR)",         value: "#BCR-"  },
  { label: "Business Partnership (#BPR)", value: "#BPR-"  },
  { label: "Nakshatra Analysis (#NAR)",   value: "#NAR-"  },
  { label: "Sade Sati (#SSR)",            value: "#SSR-"  },
  { label: "Mangal Dosha (#MDR)",         value: "#MDR-"  },
  { label: "Kaal Sarp Dosha (#KSD)",      value: "#KSD-"  },
  { label: "Pitra Dosha (#PDR)",          value: "#PDR-"  },
  { label: "Comprehensive Dosha (#CDRR)", value: "#CDRR-" },
  { label: "Government Job (#GR)",        value: "#GR-"   },
];
